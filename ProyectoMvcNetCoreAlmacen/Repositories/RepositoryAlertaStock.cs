...
namespace ProyectoMvcNetCoreAlmacen.Repositories
{
    public class RepositoryAlertaStock
    {
        ...
        public async Task InsertAlertaAsync(int idAlerta, int idProducto, int idTienda, DateTime fechaAlerta, string estado)
        {
        ...
        public async Task UpdateAlertaAsync(int idAlertaStock, int idProducto, int idTienda, DateTime fechaAlerta, string estado)
        {
